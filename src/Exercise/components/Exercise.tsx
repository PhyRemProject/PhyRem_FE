    ...
    return (
        <group ref={group} {...props} dispose={null}>
            <group rotation={[0, 0, 0]} scale={[0.1, 0.1, 0.1]}>
                <primitive object={loaded.scene.children[0].children[0]} />
    ...
    return (
        <>
            <div className="h-100 w-100">
                <Row style={{ height: "95%" }}>
                    <Col xs={9}>
                        <Canvas camera={{ fov: 50, position: [0.0, 2.0, 15.0], rotation: [0, 0, 0] }}>
                            <CameraControls />
                            <ambientLight />
                    ...
                    <Col xs={3}>
                        Arm
                         <Slider
                            ...
                            value={arm.current}
                            onChange={(event: any, newValue: number | number[]) => {
                                arm.current = (newValue as number)
                            }}
                            step={0.1}
                            min={0}
                            max={Math.PI * 2}
